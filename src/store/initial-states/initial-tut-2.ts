...
const initialTut2State: EditorFrameObjects = {
    0: {
        id: 0,
    ...
    1: {
        ...
        labelSlotsDict: {
            ...
            1: {slotStructures: {operators: [{code: ""}, {code: ""}], fields: [{code: ""}, {code: "Hello from TUTORIAL 2!", quote: "\""}, {code: ""}]}}},
        caretVisibility: CaretPosition.none,
    },
...
export default initialTut2State;